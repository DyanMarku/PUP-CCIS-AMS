<style>
  #content-wrapper {
    background-image: url('img/pup.jpg');
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./" style="color: wheat;">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page" style="color: wheat;">Create Class</li>
            </ol>
          </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="card mb-4 glass-background">
                <div class="card-body">
                  <form method="post">
                    ...
                    if (isset($Id)) {
                    ?>
                      <button type="submit" name="update" class="btn btn-warning" style="background-color: maroon;">Update</button>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <?php
                    } else {
                    ?>
                      <button type="submit" name="save" class="btn btn-primary" style="background-color: maroon; border-color: orange;">Save</button>
                    <?php
                    }
                    ?>
                  </form>
                ...
                <div class="col-lg-12">
                  <div class="card mb-4  glass-background">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                      <h6 class="m-0 font-weight-bold" style="color: black;">All Classes</h6>
                    </div>
                          ...
                          if ($num > 0) {
                            while ($rows = $rs->fetch_assoc()) {
                              ...
                              <tr>
                                ...
                                <td><a  style='color: black;' href='?action=edit&Id=" . $rows['Id'] . "'><i class='fas fa-fw fa-edit'></i >Edit</a></td>
                                <td><a  style='color: black;' href='?action=delete&Id=" . $rows['Id'] . "'><i class='fas fa-fw fa-trash'></i>Delete</a></td>
                              </tr>";
                            }
                          } else {
                            echo
